...
<head>
    ...
    <link href="css/tour-article2.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="sec-guid-cate">
            <div class="container">
                <div class="box-cate">
                    <div class="h-text-cate">
                        <p>
                            GUIDEBOOK CATEGORIES
                        </p>
                    </div>
                    <div class="d-text-cate">
                        <p>
                            หมวดหมู่รอบรู้เรื่องเที่ยว
                        </p>
                    </div>
                    <br>
                    <div class="row-blog">
                        <?php for($j=1;$j<=8;$j++){?>
                        <div class=" col-blog ">
                            <div class="item-blog" style="background-image: url(upload/bc<?=$j?>.png);">
                                <div class="text-blog">
                                    <div class="h-text-blog">
                                        <p> Navigation </p>
                                    </div>
                                    <div class="d-text-blog">
                                        <p> รถไฟฟ้าและการเดินทาง </p>
                                    </div>
                                </div>
                            </div>
                        </div>
