...
<head>
    ...
    <link href="css/tour-list.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="travel-h" class="bg-parallax"
            style="background:url(images/travel-h.png) no-repeat center center; background-size:cover;">
            <div class="container">
                <div data-aos="fade-down-right">
                    <div class="text-travel-h">
                        <p>
                            TRAVEL TO OUTHER POPULAR COUNTRIES
                        </p>
                    </div>
                    <div class="text-travel-h2">
                        <p>
                            “เที่ยวประเทศฮิตอื่นๆ”
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section id="box-slide-taiwai">
            <div class="container">
                <div class="text-box-Taiwai">
                    <p>
                        แพ็คเกจทัวร์ไต้หวัน
                        <a href="">
                            <font>
                                ดูแพ็คเกจไต้หวันทั้งหมด >
                            </font>
                        </a>
                    </p>
                </div>
        ...
        <section id="box-slide-japan">
            <div class="container">
                <div class="text-box-japan">
                    <p>
                        แพ็คเกจทัวร์ญี่ปุ่น
                        <a href="">
                            <font>
                                ดูแพ็คเกจญี่ปุ่นทั้งหมด >
                            </font>
                        </a>
                    </p>
                </div>
        ...
        <section id="box-slide-makao">
            <div class="container">
                <div class="text-box-makao">
                    <p>
                        แพ็คเกจทัวร์มาเก๊า
                        <a href="">
                            <font>
                                ดูแพ็คเกจมาเก๊าทั้งหมด >
                            </font>
                        </a>
                    </p>
                </div>
        ...
        <section id="box-slide-southาorea">
            <div class="container">
                <div class="text-box-southาorea">
                    <p>
                        แพ็คเกจทัวร์เกาหลีใต้
                        <a href="">
                            <font>
                                ดูแพ็คเกจเกาหลีใต้ทั้งหมด >
                            </font>
                        </a>
                    </p>
                </div>
        ...
        <section id="box-slide-thai">
            <div class="container">
                <div class="text-box-thai">
                    <p>
                        แพ็คเกจทัวร์ไทย
                        <a href="">
                            <font>
