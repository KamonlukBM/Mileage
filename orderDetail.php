...
<body>
    ...
    <main>
        ...
        <section id="order-detail" class="container border-bottom">
            <div class="text-bn">
                <div class="text-or">
            ...
            <div class="row">
                <div class="text-d-list border-bottom">
                    ...
                    <div class="col-sm-5">
                        ...
                        <span style="color:#595959;font-size:14px;">*หนังสือเดินทางไทยไม่ต้องใช้วีซ่า หากพำนักอยู่ไม่เกิน 90 วัน รบกวนตรวจสอบวันหมดอายุของหนังสือ
