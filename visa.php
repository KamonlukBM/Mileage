...
<body>
    ...
    <main>
        ...
        <section id="travel-tour-add2" class="bg-parallax" style="background:url(upload/vs1.png) no-repeat center center; background-size:cover;">
            ...
            <div data-aos="fade-down-right">
                ...
                <div class="text-travel-tour-article-d">
                    <p>เชื่อมต่อโลกออนไลน์ได้ทุกที่ทุกเวลา
                    </p>
                </div>
            </div>
        </section>

        <section id="connect-visa" class="container">
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a href="">
                            <img class="card-img-top" src="upload/bannerCounty.png" alt="Card image cap">
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="">
        ...
        <section id="article-visa" class="bg-gray">
            <div class="container">
                ...
                <div class="swiper mySwiper2">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-img-top" src="upload/g2.jpg" alt="Card image cap" style="border-radius: 10px 10px 0px 0px;">
                                <div class="but-sec-activites">
                                    <a href="#">
                                        <button class="button button16"> Hong Kong </button>
                                    </a>
