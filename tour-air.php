...
<head>
    ...
    <link href="css/tour-air.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="travel-tour-add2" class="bg-parallax" style="background:url(upload/at1.png) no-repeat center center; background-size:cover;">
            ...
            <div data-aos="fade-down-right">
                ...
                <div class="text-travel-tour-article-d">
                    <p>จองเที่ยวบินกับเราปลอดภัย เที่ยวสบาย</p>
                </div>
            </div>
        </section>

        <div class="container" id="tour-air-tic">
            <div class="div1">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-tt-box-time" id="myDIV">
                            <button class="button button2">One-way </button>
                ...
                <div class="search-but">
                    <button class="button button8"><i class="fas fa-search"></i> ค้นหาเที่ยวบิน</button>
                </div>

            </div>
        </div>

        <section id="ticket-in" class="container">
            <div class="text-tic">
        ...
        <section id="ticket-hot" class="container">
            ...
            <div class="d-flex justify-content-between">
                <p style="font-size: 20px;">Singapore</p>
                <a href="">ดูเที่ยวบินประสิงคโปร์ ></a>
            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="card-tic">
                            <div class="card-tic-body">
                                <div class="text-h-tic">
                                    <p>กรุงเทพฯ - สิงคโปร์</p>
                                    <button class="button button2">เที่ยวเดียว</button>
                                </div>
                                <div class="cate-tic">
                                    <img src="upload/tb1.png" class="me-2">
                                    <p>การบินไทย (MH)</p>
                            ...
                            <div class="card-tic-foot">
                                <p>เริ่มต้นที่ 4,700฿</p>
                                <button class="button button4"><i class="fas fa-plane"></i> จองตั๋วเครื่องบิน</button>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
        ...
        <section id="ticket-zone" class="container">
            <div class="text-h-zone">
                ...
                <span>จองเที่ยวบินกับเราปลอดภัย เที่ยวสบาย</span>
            </div>
            <div class="row zone">
                <div class="col-sm-4">
                    <div class="text-tt-zone">
                        <p>ทวีปเอเชีย</p>
                        <span>ตั๋วเครื่องบินภายในทวีปเอเชีย</span><br><br>
            ...
            <div class="row zone">
                <div class="col-sm-4">
                    <div class="text-tt-zone">
                        <p>ทวีปยุโรป</p>
                        <span>ตั๋วเครื่องบินภายในทวีปยุโรป</span><br><br>
            ...
            <div class="row zone">
                <div class="col-sm-4">
                    <div class="text-tt-zone">
                        <p>ทวีปอเมริกา</p>
                        <span>ตั๋วเครื่องบินภายในอเมริกา</span><br><br>
            ...
            <div class="row zone">
                <div class="col-sm-4">
                    <div class="text-tt-zone">
                        <p>ทวีปออสเตรเลีย</p>
                        <span>ตั๋วเครื่องบินภายในออสเตรเลีย</span><br><br>
            ...
            <div class="row zone">
                <div class="col-sm-4">
                    <div class="text-tt-zone">
                        <p>ทวีปแอฟริกา</p>
                        <span>ตั๋วเครื่องบินภายในทวีปแอฟริกา</span><br><br>
        ...
        <div id="myModal" class="modal">
            ...
            <div class="modal-content">
                ...
                <p>ไฟล์การบินโปรโมชัน</p>
                <img src="upload/check-fight.png" style="width: 750px; display:block; margin:auto;">
            </div>
        ...
        <div id="myModal2" class="modal2">
            ...
            <div class="modal-content">
                ...
                <div class="card-popup">
                    <p>คุณต้องการจองเที่ยวบินแบบใด ?</p>
                    <span>คุณต้องจองเที่ยวบินแบบทางเดียว หรือ แบบไปกลับ</span>
                </div>
                <div class="card-popup">
                    <button class="button7" id="myBtn4">One-way</button>
                    <button class="button5" id="myBtn3">Round-trip</button>
                </div>
        ...
        <div id="myModal3" class="modal3">
            ...
            <div class="modal-content">
                ...
                <div class="Flight-two">
                    <p>Flight details</p>
                    <span>รายละเอียดตั๋วเครื่องบิน</span>
                    <div class="bow-trip">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="box-tic">
                                    <p>เส้นทาง : <span>กรุงเทพฯ - สหรัฐอเมริกา</span></p>

                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="box-tic">
                                    <p>สายการบิน : <span>เอมิเรตส์แอร์ไลน์ (EK)</span></p>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="box-tic">
                                    <p>ราคา : <span>17,100฿</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <br>
                    <span>ช่วงวันและเวลาที่ไม่เข้าร่วมรายการ</span><br>
                    <small>ตั้งแต่วันที่ 3-10 เวลา 01.00pm - 05.00pm</small><br><br>
                    <p>Flight ticket form</p>
                    <span>แบบฟอร์มจองตั๋วเครื่องบิน (3 ขั้นตอนง่ายๆ)</span>
                    <div class="form-tic">
                        <div class="row">
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <label>สนามบินต้นทาง</label>
                                <input type="text" class="form-control" placeholder="สนามบินต้นทาง">
                            </div>
                            <div class="col-sm-6">
                                <label>สนามบินปลายทาง</label>
                                <input type="text" class="form-control" placeholder="สนามบินปลายทาง">
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <label>วันเดินทาง (เที่ยวบินขากลับ)</label>
