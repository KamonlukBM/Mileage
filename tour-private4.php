...
<head>
    ...
    <link href="css/tour-private4.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="travel-tour-list2" class="bg-parallax" style="background:url(images/tr1.png) no-repeat center center; background-size:cover;">
        </section>
        ...
        <section id="detail-pack">
            <div class="container">
                <div class="text-h-city">
                    <p>รายละเอียดแพ็กเกจ</p>
                </div>
                <div class="text-tt">
                    <p>ตั๋วเครื่องบินไปกลับ กรุงเทพ-ฮ่องกง สายการบินฮ่องกงแอร์ไลน์</p>
                    <p>ภาษีสนามบินทั้งที่ประเทศไทยและประเทศฮ่องกง</p>
                    <p>รถรับส่ง ระหว่าง สนามบิน - โรงแรม - สนามบิน</p>
                    <p>โรงแรมที่พัก จำนวน 1 คืน ณ โรงแรม DISNEY'S HOLLYWOOD หรือ DISNEY EXPLORER LODGE หรือ DISNEYLAND HOTEL ( 1 ห้องพักได้ 2-4 ท่าน )</p>
                    <p>โรงแรมที่พักในตัวเมืองฮ่องกง 1 คืน</p>
                    <p>ตั๋วดิสนีย์แลนด์ 1 วัน ท่านละ 1 ใบ</p>
                    <p>ฟรีซิตี้ทัวร์ฮ่องกงครึ่งวัน (เจ้าแม่กวนอิมริมทะเล REPULSE BAY/วัดกังหัน/วัดเจ้าแม่กวนอิม HUNG HUM/โรงงานจิวเวลรี่)</p>
                    <br>
                ...
                <br>
                <div>
                    <embed src="upload/540cb75550adf33f281f29132dddd14fded85bfc.pdf" type="application/pdf" frameBorder="0" scrolling="auto" height="500px" width="100%"></embed>
                </div>
            </div>
