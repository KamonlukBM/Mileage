...
<head>
    ...
    <link href="css/tour-list5.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="travel-tour-list5" class="bg-parallax"
            style="background:url(images/tl4.png) no-repeat center center; background-size:cover;">
            <div class="container">
                <div class="text-h-list4">
                    <p>
                        Fix Disney & The City 3 วัน 2 คืน ในเมืองและดิสนีย์ พร้อมบัตรสวนสนุก 1 วัน
                    </p>
                </div>
                <div class="text-d-list4">
                    <p>
                        <i class="fas fa-plane" aria-hidden="true"></i> โดยสายการบินฮ่องกงแอร์ไลน์
                    </p>
                </div>
            </div>
        </section>
        ...
        <section id="sec-detail-box-text">
            <div class="container">
                <div class="text-boc-tt">
                    <p>
                        กรอกข้อมูลของท่าน
                    </p>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card mb-3" style="max-width: 350px;border-radius: 9px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="upload/li4.png" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <p class="card-text">
                                        ...
                                        <p class="card-text2">
                                            พิเศษ ฟรีนั่งกระเช้าไหว้พระใหญ่ วัดโป่หลินหรือ นั่งรถเปิดประทุน ชมเมือง ...
                                        </p>
                                        <p class="card-text3">
                                            เริ่มต้นที่ <font>
                                                9,999฿
                    ...
                    <div class="col-lg-8">
                        <div class="div1">
                            <div class="h-head-box-h">
                                <p>
                                    เลือกวันและเวลาที่จะใช้งานทัวร์เสริม
                                </p>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="div1-1">
                            <div class="h-head-box-h">
                                <p>
                                    แจ้งสถานที่สำหรับรถรับส่ง
                                </p>
                            </div>
                            <div class="text-car-t">
                                <p>
                                    สถานที่ไปรับ (ขาไป)
                                </p>
                            </div>
                            <form>
                                <div class="mb-3">
                                    <input type="email" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="สถานที่ไปรับ (ขาไป)">
                                </div>
                            </form>
                            <div class="text-car-t2">
                                <p>
                        ...
                        <div class="div2">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <input type="email" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Mr">
                                    <br>
                                    <div class="d-text-d1">
                                        <p> เบอร์โทรศัพท์ </p>
                                    </div>
                                    <input type="email" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="เบอร์โทรศัพท์">
                                </div>
                                <div class="col-lg-4">
                                    <div class="d-text-d2">
                                        <p> ชื่อ <font>
                                    ...
                                    <input type="email" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="ชื่อ (ภาษาอังกฤษ)">
                                    <br>
                                    <div class="d-text-d2">
                                        <p> LIne ID
                                        </p>
                                    ...
                                    <input type="email" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="LIne ID">
                                </div>
                                <div class="col-lg-4">
                                    <div class="d-text-d3">
                                        <p> นามสกุล <font>
                                    ...
                                    <input type="email" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="นามสกุล (ภาษาอังกฤษ)">
                                    <br>
                                    <div class="d-text-d2">
                                        <p> อีเมล
                                        </p>
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="defaultCheck1">
                                    <div class="t-text-check-c">
                                        <p>
                                            ผู้จองเป็นหนึ่งในผู้เดินทาง
                                        </p>
                                    </div>
                                </label>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="div3">
                            <div class="h2-head-box-h2">
                                <p>
                                    ข้อมูลผู้เดินทาง
                                </p>
                            </div>
                            <div class="h2-head-box-h3">
                                <p>
                                    ตรงตามหนังสือเดินทาง
                                </p>
                            </div>
                            <div class="but-sec-but-add">
                                <a href="#">
                                    <button class="button button17"> เพิ่มรายชื่อผู้ใช้งาน </button>
                                </a>
                            </div>
                            <div class="text2-text-t2">
                                <p>
                                    เพิ่มผู้ใช้งานทัวร์เสริมเพิ่มเติม
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-lg-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="email" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="ผู้ใหญ่">
                                </div>
                            </div>
                        </div>
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">
                                <div class="text-check-t">
                                    <p>
                                        ข้าพเจ้ายอมรับ นโยบายส่วนบุคคล ให้สามารถจัดเก็บข้อมูลเพื่อใช้ในการติดต่อ
                                        และให้ข้อมูลอันเป็นประโยชน์กับข้าพเจ้า
                                    </p>
                                </div>
                            </label>
                        </div>
                ...
                <div class="but-sec-but-add">
                    <a href="#">
                        <button class="button button18"> ต่อไป </button>
                    </a>
                    <a href="#">
                        <button class="button button20"> ย้อนกลับ </button>
                    </a>
                </div>
