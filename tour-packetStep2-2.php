...
<head>
    ...
    <link href="css/tour-packetStep2.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="reserve-room" class="container">
            <div class="text-h-flight">
                <p>สำรองห้องพัก</p>
            </div> <br>
            <div class="row">
                <div class="text-h-room col-sm-6">
                    <p>Disney & The City 3 วัน 2 คืน</p>
                    <span style="color: #FF6701;">*สิทธิพิเศษให้คุณเลือก โรงแรม DISNEY'S HOLLYWOOD หรือ DISNEY EXPLORER LODGE หรือ DISNEYLAND HOTEL จำนวน 1 คืน
                        และ โรงแรมที่พักในตัวเมืองฮ่องกงอีกจำนวน 1 คืน </span>
                </div>
            </div>
            <br>
            <br>
