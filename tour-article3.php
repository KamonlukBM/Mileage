...
<head>
    ...
    <link href="css/tour-article3.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="sec-thai-head">
            <div class="row">
                <div class="col-lg-6">
                    <div class="w3-container w3-center">
                        <div class="text-h-left">
                            <img class="card-img-top" src="upload/text1.png" alt="...">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="img-h-fight">
                        <img class="card-img-top" src="upload/hr1.png" alt="...">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="sec-pick">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="box-pick">
                            <div class="h-pick-text">
                                <p>
                                    Editor's Pick
                                </p>
                            </div>
                            <div class="but-sec-ban">
                                <button class="button button19"> SIGHTSEEING </button>
                            </div>
                            <div class="d-pick-text1">
                                <p>
                                    เจาะลึก วัดหวังต้าเซียน (Wong Tai Sin Temple)
                                </p>
                            </div>
                            <div class="d-pick-text2">
                                <p>
                                    กิน เที่ยว ช้อป ตะลุยสวนสนุก ครบสูตร ใน 3 วัน 2 คืน มาพร้อมกับประสบการณ์อันยอดเยี่ยม
                                    ได้พักในเมือง 1 คืนและพักในดิสนีย์ 1 คืน สามารถเลือกโรงแรมได้เองทั้งหมด...
                                </p>
                            </div>
                            <div class="but-sec-pick">
                                <a href="#">
                                    <button class="button button20"> อ่านเพิ่มเติม </button>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="box-img-pick">
                            <img class="card-img-top" src="upload/ep.png" alt="...">
                        </div>
                    </div>
                        ...
                        <div class="h-text-art">
                            <p>
                                ...
                                <select class="form-select" aria-label="Default select example">
                                    <option selected> เรียงตามยอดวิว </option>
                                ...
                                <select class="form-select" aria-label="Default select example">
                                    <option selected> แผนเดินทาง </option>
