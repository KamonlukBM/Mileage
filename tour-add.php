...
<head>
    ...
    <link href="css/tour-add.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="travel-tour-add">
            <div class="container">
                <div data-aos="fade-down-right">
                    <div class="text-travel-tour-add">
                        <p>
                            ทัวร์เสริมและบัตรเข้าสถานที่เที่ยว
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="t-but-but-tab">
            <div class="container">
                <ul class="nav nav-pills justify-content-center">
                    <li class="active"><a data-toggle="pill" href="#home"> กิจกรรมทั้งหมด </a></li>
                    <li><a data-toggle="pill" href="#menu1"> ประสบการณ์ </a></li>
                    <li><a data-toggle="pill" href="#menu2"> สวนสนุก </a></li>
                    <li><a data-toggle="pill" href="#menu3"> อาหาร </a></li>
                    <li><a data-toggle="pill" href="#menu4"> นำเที่ยวรอบเมือง </a></li>
                </ul>
                    ...
                    <div class="h-text-activites">
                        <p>
                            ...
                            <select class="form-select" aria-label="Default select example">
                                <option selected> ประเทศ/เมือง </option>
                            ...
                            <div class="col-lg-3">
                                <div class="card">
                                    ...
                                    <div class="but-sec-activites">
                                        <a href="#">
                                            <button class="button button16"> ฮ่องกง </button>
                                        </a>
                                        <a href="#">
                                            <button class="button button17"> ประสบการณ์ </button>
                                        </a>
                                    </div>
                                    <div class="card-body">
