...
<head>
    ...
    <link href="css/tour-packetStep6.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="order-detail" class="container">
            <div class="text-bn">
                <div class="text-or">
                    <h2>ขอบคุณสำหรับการสั่งซื้อสินค้า</h2>
                    <p>เลขที่รายการสั่งซื้อ :
                        <span style="color:#FF9D5B">ORDER E00264</span>
                    </p>
                </div>
                <hr>
                <div class="text-recon">
                    <p style="color:#FF9D5B">กรุณารอการติดต่อกลับจากเรา</p>
                ...
                <button class="button15">กลับหน้าแรก</button>
            </div>
        </section>
                    ...
                    <div class="tabnav">
                        <ul class="tab">
                            <li class="tablinks3 active" onclick="openNav(event, '1')" id="defaultOpen2">
                                <span class="tab-title-text">&nbsp;รายละเอียดการสั่งซื้อ</span>
                            </li>
                            <li class="tablinks3" onclick="openNav(event, '2')">
                                <span class="tab-title-text">&nbsp;รายละเอียดการจอง</span>
                            </li>
                            <li class="tablinks3" onclick="openNav(event, '3')">
                        ...
                        <div id="1" class="tabcontent3">
                            <section id="order-list" class="container">
                                ...
                                <div class="text-h-list border-bottom">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <p style="color:#000000;font-size:20px;">รายการที่ 123</p>
                                        </div>
                                        <div class="col-sm-7">
                        ...
                        <div id="2" class="tabcontent3">
                            <section id="order-list" class="container">
                                ...
                                <div class="text-h-list border-bottom">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <p style="color:#000000;font-size:20px;">รายการที่ 1234</p>
                                        </div>
                                        <div class="col-sm-7">
                                            <p>TASK DESCRIPTION</p>
                                        </div>
                        ...
                        <div id="3" class="tabcontent3">
                            <section id="order-list" class="container">
                                ...
                                <div class="text-h-list border-bottom">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <p style="color:#000000;font-size:20px;">รายการที่ 12345</p>
                                        </div>
                                        <div class="col-sm-7">
                                            <p>TASK DESCRIPTION</p>
                                        </div>
