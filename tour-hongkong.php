...
<head>
    ...
    <link href="css/tour-hongkong.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="travel-hk" class="bg-parallax"
            style="background:url(images/travel-hk.png) no-repeat center center; background-size:cover;">
            <div class="container">
                <div data-aos="fade-down-right">
                    <div class="text-travel-hk">
                        <p>
                            HONGKONG
                        </p>
                    </div>
                    <div class="text-travel-hk2">
                        <p>
                            “แพ็กเกจทัวร์ฮ่องกง”
                        </p>
                    </div>
        ...
        <section id="best-fix-hk">
            <div class="container">
                <div class="text-best-fix-hk">
                    <p>
                        Best Fix
                    </p>
                </div>
                <div class="text-best-fix-hk2">
                    <p>
                        ดีลสุดคุ้ม กำหนดเงื่อนไขให้
                    </p>
                </div>
            </div>
        </section>
        ...
        <section id="sec-but-t">
            <div class="t-but-but-tab">
                <div class="container">
                    <ul class="nav nav-pills justify-content-center">
                        <li class="active"><a data-toggle="pill" href="#home"> Best Fix </a></li>
                        <li><a data-toggle="pill" href="#menu1"> Smart Flex </a></li>
                        <li><a data-toggle="pill" href="#menu2"> Full Tour </a></li>
                        <li><a data-toggle="pill" href="#menu3"> Best Selected </a></li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <div id="home" class="tab-pane fade in active">
                            ...
                            <div class="container">
                                ...
                                <div class="text-box-monthly">
                                    <p>
                                        Monthly Promotion 3days 2nights
                                    </p>
                                </div>
                                    ...
                                    <div class="swiper mySwiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="card">
                                                    <img class="card-img-top" src="upload/hk1.png" alt="Card image cap"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text">กิน เที่ยว ช้อป ตะลุยสวนสนุก ครบสูตร ใน3วัน
                                                            2คืน
                                                            มาพร้อมกับประสบการณ์อัน ยอดเยี่ยม ได้พักในเมือง 1คืน
                                                            และพักใน...</p>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card">
                                                    <img class="card-img-top" src="upload/hk2.png" alt="Card image cap"
                                                        style="border-radius: 10px 10px 0px 0px;">
                                                    <div class="card-body">
                                                        <p class="card-title"> April Chillout 3 วัน 2 คืน (โปรโมชั่น
                                                            ประจำเดือนเมษายน)
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card">
                                                    <img class="card-img-top" src="upload/hk3.png" alt="Card image cap"
                                                        style="border-radius: 10px 10px 0px 0px;">
                                                    <div class="card-body">
                                                        <p class="card-title"> April Chillout 3 วัน 2 คืน (โปรโมชั่น
                                                            ประจำเดือนเมษายน)
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card">
                                                    <img class="card-img-top" src="upload/hk4.png" alt="Card image cap"
                                                        style="border-radius: 10px 10px 0px 0px;">
                                                    <div class="card-body">
                                                        <p class="card-title"> April Chillout 3 วัน 2 คืน (โปรโมชั่น
                                                            ประจำเดือนเมษายน)
                                ...
                                <div class="text-box-monthly">
                                    <p>
                                        Monthly Promotion 4days 3nights
                                    </p>
                                </div>
                                <div data-aos="zoom-in">
                                    <div class="swiper mySwiper">
        ...
        <br><br>
        <section id="back-tour-tip" class="bg-parallax"
            ...
            <div class="container">
                ...
                <div class="but-back-tip">
                    <button class="button button10"> ติดต่อจัดทริปส่วนตัว </button>
                </div>
            </div>
        </section>
        ...
        <section id="sec-guidbook">
            <div class="container">
                <div class="text-h-guidebook">
                    <p>
                        GUIDEBOOK
                    </p>
                </div>
                <div class="text-h-guidebook2">
                    <p>
                        รอบรู้เรื่องเที่ยว
                    </p>
                </div>
