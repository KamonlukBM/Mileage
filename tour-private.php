...
<head>
    ...
    <link href="css/tour-private.css" rel="stylesheet">
    ...
    <main>
        ...
        <section id="travel-tour-add2" class="bg-parallax" style="background:url(upload/tp1.png) no-repeat center center; background-size:cover;">
            ...
            <div data-aos="fade-down-right">
                ...
                <div class="w3-center">
                    <a href="">
                        <buttton class="button button1">สร้างทริปส่วนตัวด้วยตัวเอง</buttton>
                    </a>
                </div>
            </div>
        </section>
                        ...
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="">
                                        <div class="promotion">
                                            <img src="upload/tp2.png">
                                            <div class="text-pro">
                                                <p>โปรโมชั่นประจำเดือน</p>
                                                <p class="h4">MONTHLY PROMOTION</p>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                            ...
                            <div class="col-sm-12 mb-3">
                                <a href="">
                                    <div class="promotion">
                                        ...
                                        <div class="text-pro">
                                            <p>โปรโมชั่นประจำเดือน</p>
                                            <p class="h6">MONTHLY PROMOTION</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
