...
<head>
    ...
    <link href="css/tour-packetStep3.css" rel="stylesheet">
                ...
                <div class="col-sm-8">
                    <table style="width:100%" id="table-desk">
                        <tr>
                            ...
                            <th>
                                <p class="w3-center">จำนวนห้องพัก</p>
                            </th>
                        </tr>
                        <tr>
                            <td class="col-5">
                                ...
                                <a href=""><i class="fas fa-info-circle"></i> เข้าพักได้สูงสุด 5 ท่าน เฉพาะกรณีมีผู้เข้าพักเป็นเด็ก
                                    ที่ไม่ต้องการใช้เตียง จำนวน 2 ท่าน</a><br>
                                <a href="">หมายเหตุ: Lorem Ipsum is simply dummy text of the
                            ...
                            <td class="col-3">
                                <input type="number" class="form-control" style="width: 50%; margin:auto" value="1">
                            </td>
                        </tr>
                        <tr>
                            <td class="col-5">
