...
<head>
    ...
    <link href="css/tour-article.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="travel-tour-article">
            <div class="w3-content" style="max-width:1700px">
                <img class="mySlides" src="upload/sl1.png" style="width:100%;display:none">
                <img class="mySlides" src="upload/sl2.png" style="width:100%">
                <img class="mySlides" src="upload/sl3.png" style="width:100%;display:none">
                <img class="mySlides" src="upload/sl4.png" style="width:100%;display:none">
                <img class="mySlides" src="upload/sl5.png" style="width:100%">
                <img class="mySlides" src="upload/sl6.png" style="width:100%;display:none">

                <div class="w3-container w3-center">
                    <div class="but-sec-h">
                        <a href="#">
                            <button class="button button9"> NEW ARTICLE </button>
                        </a>
                    </div>
                </div>
                <div data-aos="fade-down-right">
                    ...
                    <div class="text-travel-tour-article-d">
                        <p>กิน เที่ยว ช้อป ตะลุยสวนสนุก ครบสูตร ใน3วัน 2คืน มาพร้อมกับประสบการณ์อันยอดเยี่ยม
                            ได้พักในเมือง 1 คืน และพักในดิสนีย์ 1 คืน สามารถเลือกโรงแรมได้เองทั้งหมด
                        </p>
                    </div>
                    <div class="text-travel-tour-article-d2">
                        <p> โพสต์เมื่อ 6 กุมภาพันธ์ 2021 </p>
                    </div>
                </div>

                <div class="w3-row-padding w3-section">
                    <div class="w3-col s2">
                        <img class="demo w3-opacity w3-hover-opacity-off" src="upload/sl1.png"
                            style="width:100%;cursor:pointer" onclick="currentDiv(1)">
                    </div>
                    <div class="w3-col s2">
                        <img class="demo w3-opacity w3-hover-opacity-off" src="upload/sl2.png"
                            style="width:100%;cursor:pointer" onclick="currentDiv(2)">
                    </div>
                    <div class="w3-col s2">
                        <img class="demo w3-opacity w3-hover-opacity-off" src="upload/sl3.png"
                            style="width:100%;cursor:pointer" onclick="currentDiv(3)">
                    </div>
                    <div class="w3-col s2">
                        <img class="demo w3-opacity w3-hover-opacity-off" src="upload/sl4.png"
                            style="width:100%;cursor:pointer" onclick="currentDiv(4)">
                    </div>
                    <div class="w3-col s2">
                        <img class="demo w3-opacity w3-hover-opacity-off" src="upload/sl5.png"
                            style="width:100%;cursor:pointer" onclick="currentDiv(5)">
                    </div>
                    <div class="w3-col s2">
                        <img class="demo w3-opacity w3-hover-opacity-off" src="upload/sl6.png"
                            style="width:100%;cursor:pointer" onclick="currentDiv(6)">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-img-top" src="upload/sb1.png" alt="Card image cap"
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-img-top" src="upload/sb2.png" alt="Card image cap"
                                    style="border-radius: 10px 10px 0px 0px;">
                                <div class="t-name-h1">
                                    <p>
                                        HongKong
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-img-top" src="upload/sb3.png" alt="Card image cap"
                                    style="border-radius: 10px 10px 0px 0px;">
                                <div class="t-name-h1">
                                    <p>
                                        Canada
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-img-top" src="upload/sb4.png" alt="Card image cap"
                                    style="border-radius: 10px 10px 0px 0px;">
                                <div class="t-name-h1">
                                    <p>
                                        American
        ...
        <br>
        <section id="sec-tour-art">
            <div class="t-but-but-tab">
                <div class="container">
                    <ul class="nav nav-pills justify-content-center">
                        <li class="active"><a data-toggle="pill" href="#home"> บทความทั้งหมด </a></li>
                        <li><a data-toggle="pill" href="#menu1"> รถไฟฟ้าและการเดินทาง </a></li>
                        <li><a data-toggle="pill" href="#menu2"> ร้านอาหาร </a></li>
                        <li><a data-toggle="pill" href="#menu3"> รีวิวโรงแรม </a></li>
                        <li><a data-toggle="pill" href="#menu4"> ชมบรรยากาศ </a></li>
                        <li><a data-toggle="pill" href="#menu5"> เคล็ดลับ </a></li>
                        <li><a data-toggle="pill" href="#menu6"> พูดคุย </a></li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <div class="h-text-activites">
                            <p>
                                All Countries
                            </p>
                        </div>
                        <div class="d-detail-text-activites">
                            <p>
                                รอบรู้เรื่องเที่ยวทั้งหมด
                            </p>
                        </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="card">
                                        ...
                                        <div class="but-sec-hi">
                                            <a href="#">
                                                <button class="button button10"> Highlight</button>
                                            </a>
                                        </div>
