...
<head>
    ...
    <link href="css/visa2.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="travel-tour-add2" class="bg-parallax" style="background:url(upload/vs2.png) no-repeat center center; background-size:cover;">
        </section>
                ...
                <div class="col-sm-5 col-md-4">
                    <div class="card">
                        <div class="card-price">
                            <p>
                                <font style="font-size: 20px;font-weight: 600;color: #F2692B;">
                                    9,999฿
                                </font>
                            </p>
                            <p><i class="far fa-clock"></i> ใช้งานได้เร็วที่สุดในวันที่: 24 มี.ค. 2021</p>
                        </div>
                        <hr>
                        <div class="but-box-slide">
                            <a href="#">
                                <button class="button button9"> เลือกแพ็คเกจ </button>
                            </a>
                        </div>
                        <div class="contact">
                            <p>สอบถามเพิ่มเติมทาง</p>
                            <div>
                                <i class="fab fa-line" style="color: #01C301;"></i>
                                <i class="fab fa-facebook-messenger" style="color: #1940C7;"></i>
                            </div>
