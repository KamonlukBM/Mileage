...
<body>
    ...
    <main>
        ...
        <section id="img-product" class="container">
                ...
                <div class="col-sm-7">
                    <div class="border-bottom">
                        <div class="text-h-city">
                            <p>CALM นำมันหอมระเหย บำบัดอารมณ์</p>
                            <p>
                                <font style="font-size: 20px;font-weight: 600;color: #1940C7;">
                                    9,999฿
                                </font>
                            </p>
                        </div>
                    ...
                    <div class="border-bottom">
                        <div class="btn-a-s">
                            ...
                            <input class="form-control text-center" style="float: left;" placeholder="" type="text" id="1" value="1">
                            <button class="btn bg-gray4 add" type="button" id="add">+</button>
                        </div>
                        <div class="cart">
                            <a href="">
                                <button class="button button21">เพิ่มลงในตะกร้า</button>
                            </a>
                        </div>
                    </div>
                    <div class="detail">
