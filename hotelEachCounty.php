...
<head>
    ...
    <link href="css/hotelEachCounty.css" rel="stylesheet">
...
<body>
    ...
    <main>
                ...
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-img-top" src="upload/sb1.png" alt="Card image cap" style="border-radius: 10px 10px 0px 0px;">
                                <div class="t-name-h1">
                                    <p>
                                        Singapore
                                    </p>
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-img-top" src="upload/sb2.png" alt="Card image cap" style="border-radius: 10px 10px 0px 0px;">
                                <div class="t-name-h1">
                                    <p>
                                        HongKong
                                    </p>
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-img-top" src="upload/sb3.png" alt="Card image cap" style="border-radius: 10px 10px 0px 0px;">
                                <div class="t-name-h1">
                                    <p>
                                        Canada
                                    </p>
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-img-top" src="upload/sb4.png" alt="Card image cap" style="border-radius: 10px 10px 0px 0px;">
                                <div class="t-name-h1">
                                    <p>
                                        American
                                    </p>
        ...
        <section id="box-slide-Recommend">
            <div class="container">
                <div class="h-text-Recommend">
                    <p>
                        Recommend Hotel in Singapore
                    </p>
                </div>
                <div class="d-detail-text-art">
                            <p>
                                โรงแรมแนะนำจากทางเรา
                            </p>
                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="but-sec-hi">
                                            <a href="#">
                                                <button class="button buttonRecom">Recommend</button>
                                            </a>
                                        </div>
                        ...
                        <div class="h-text-art">
                            <p>
                                ...
                                <select class="form-select" aria-label="Default select example">
                                    <option selected> เรทติ้ง </option>
