...
<body>
    ...
    <main>
        ...
        <section id="travel-tour-add2" class="bg-parallax" style="background:url(upload/pd1.png) no-repeat center center; background-size:cover;">
            ...
            <div data-aos="fade-down-right">
                ...
                <div class="text-travel-tour-article-d">
                    <p>ค้นพบสิ่งที่น่าตื่นตาตื่นใจและจองได้ในราคาพิเศษ
                    </p>
                </div>
            </div>
        </section>
