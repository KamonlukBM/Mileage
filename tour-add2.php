...
<head>
    ...
    <link href="css/tour-add2.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="travel-tour-add2" class="bg-parallax"
            style="background:url(images/ta2.png) no-repeat center center; background-size:cover;">
        </section>
        ...
        <section id="detail-sec">
            <div class="container">
                <div class="but-sec-detail">
                    ...
                    <a href="#">
                        <button class="button button17"> นำเที่ยวรอบเมือง </button>
                    </a>
                </div>
                <br>
                <div class="text-h-detail">
                    <p>
                        บัตรดิสนีย์แลนด์ 1 วัน (Disneyland 1 Day)
                    </p>
                </div>
        ...
        <section id="detail-sec2">
            <div class="container">
                ...
                <div class="t-text-detail-d">
                    <p>
                        <font style="font-weight: 600;"> ประเภทสินค้า : </font> E-Ticket หรือ บัตรจริง
                    </p>
                    <p>
                        <font style="font-weight: 600;"> จำนวนวันใช้งาน : </font> 1 วัน
                    </p>
                    <p>
                        <font style="font-weight: 600;"> วันหมดอายุของบัตร : </font> ใช้ได้ตั้งแต่ วันนี้ – 31 ธันวาคม
                        2562 (ไม่ต้องระบุวันใช้งาน)
                    </p>
                    <p>
                        <font style="font-weight: 600;"> วันและเวลา เปิด – ปิด : </font> วันจันทร์-วันพฤหัส 10.30-20.15
                        วันศุกร์-วันอาทิตย์และวันหยุดราชการ 10.00-20.15 สามารถเปลี่ยนแปลงได้
                        เช็คข้อมูลได้จากเว็บไซต์ทางการของฮ่องกงดิสนีย์แลนด์ <a href="#"> คลิ๊ก</a>
                    </p>
                    <p>
                        <font style="font-weight: 600;"> เงื่อนไขการซื้อบัตร :</font> จองล่วงหน้าก่อนเดินทาง 1 วัน
                    </p>
                </div>
        ...
        <section id="sec-hilight">
            <div class="container">
                <div class="t-text-hilight-h">
                    <p>
                        Hilight
                    </p>
                </div>
                <div class="t-text-hilight-d">
                    <p>
                        <i class='fas fa-caret-right'></i> สัมผัสประสบการณ์ใหม่ปี 2019 : การแสดงแสงสี “เรารักมิกกี้!”
                        การแสดงบนเวทีกลางแจ้งชุดใหม่ล่าสุด “Moana: A Homecoming Celebration” และตลาดคาริบูนิ
                        สไตล์แอฟริกัน
                    </p>
                    <p>
                        <i class='fas fa-caret-right'></i> Iron Man Experience
                        เป็นเครื่องเล่นธีมมาร์เวลเครื่องแรกสุดที่สวนสนุกดิสนีย์
                    </p>
                    <p>
                        <i class='fas fa-caret-right'></i> เครื่องเล่นแนวผาดโผนรอมาสัมผัสมากมาย อาทิเช่น Big Grizzly
                        Mountain Runaway Mine Cars, Hyperspace Mountain, RC Racer, Toy Soldier Parachute Drop เป็นต้น
                    </p>
                    <p>
                        <i class='fas fa-caret-right'></i> สนุกสนาน
                        และถ่ายภาพเป็นที่ระลึกร่วมกับตัวละครสุดโปรดปรานชื่อดังระดับโลก ออกมาต้อนรับท่านด้วยขบวนพาเหรด
                        Flights of Fantasy อันยิ่งใหญ่
                    </p>
                    <p>
                        <i class='fas fa-caret-right'></i> เปิดประสบการณ์กับขบวนพาเหรดยามค่ำคืนอันสุดแสนวิเศษและตระการตา
                        “Disney Paint The Night” Parade
                    </p>
                    <p>
                        <i class='fas fa-caret-right'></i> เพลิดเพลินไปกับ แอนท์-แมน และ เดอะ วอสพ์
                        ที่ดิสนีย์แลนด์ฮ่องกงที่แรกและที่เดียวในโลกเท่านั้น
                    </p>
                </div>
            </div>
        </section>
