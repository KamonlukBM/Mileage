...
<body>
    ...
    <main>
        ...
        <section id="travel-tour-back" class="bg-parallax"
            style="background:url(images/b-re.png) no-repeat center center; background-size:cover;">
            <div class="head-text-h">
                <p>
                    Mileageair Member
                </p>
            </div>
            <div class="detail-text-d">
                <p>
                    สมาชิก
                </p>
            </div>
                        ...
                        <div class="sec-tab-t">
                            <ul class="nav nav-tabs nav-justified" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="#home" aria-controls="home" role="tab" data-toggle="tab"> เข้าสู่ระบบ </a>
                                </li>
                                <li role="presentation">
                                    <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"> สมัครสมาชิก
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="home">
                                <form id="login-form" action="login.php">
                                    ...
                                    <input type="email" class="form-control"
                                        placeholder="กรุณากรอกอีเมล์ที่คุณเคยลงทะเบียนไว้">
                                    <br>
                                    <label for="password"> รหัสผ่าน* </label>
                                    <input type="password" class="form-control" placeholder="กรุณากรอกรหัสผ่านของคุณ">
                                    <br>
                                    <div class="re-pass">
                                        <p>
                                            ลืมรหัสผ่าน?
                                    ...
                                    <div class="w3-container w3-center">
                                        <button class="button button9"> เข้าสู่ระบบ </button>
                                    </div>
                                </form>
                            </div>
                            <div role="tabpanel" class="tab-pane" id="profile">
                                <form id="register-form" action="register.php">
                                    ...
                                    <input type="email" class="form-control" placeholder="กรุณากรอกชื่อ">
                                    <br>
                                    <label for="email"> นามสกุล* </label>
                                    <input type="email" class="form-control" placeholder="กรุณากรอกนามสกุล">
                                    <br>
                                    <label for="email"> อีเมล* </label>
                                    <input type="email" class="form-control"
                                        placeholder="กรุณากรอกอีเมล์ที่คุณเคยลงทะเบียนไว้">
                                    <br>
                                    <label for="password"> ตั้งรหัสผ่าน*(ใส่รหัสผ่าน ความยาว 6-20
                                        ตัวอักษรภาษาอังกฤษหรือตัวเลข) </label>
                                    <input type="passwordv" class="form-control" placeholder="กรุณาตั้งรหัสผ่าน">
                                    <br>
                                    <label for="password"> ยืนยันรหัสผ่าน*(ใส่รหัสผ่านเหมือนกับรหัสด้านบน) </label>
                                    <input type="password" class="form-control" placeholder="กรุณาตั้งรหัสผ่าน">
                                    <br>
                                    <div class="row">
                                        <div class="col">
                                            <label for="email"> เบอร์โทรศัพท์มือถือ* </label>
                                            <input type="text" class="form-control" placeholder="ตัวอย่าง: 012-345-6789"
                                                aria-label="First name">
                                        </div>
                                        <div class="col">
                                            <label for="email"> LINE ID (ถ้ามี) </label>
                                            <input type="text" class="form-control"
                                                placeholder="ชื่อไอดีไลน์ของคุณ หากมี" aria-label="Last name">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefault">
                                            <div class="ch-text-t">
                                                <p>
                                                    ข้าพเจ้ายินยอมให้ประมวลผลข้อมูลส่วนบุคคลของข้าพเจ้าตาม
                                                    <font>
                                                        นโยบายความเป็นส่วนตัวของ บริษัท ไมล์เลจแอร์ แอนด์ทราเวล จำกัด
                                                    </font>
                                                </p>
                                            </div>
                                        </label>
                                    ...
                                    <br>
                                    <div class="pin-text-t">
                                        <p>
                                            <i class='fas fa-caret-right'></i> บริษัท ไมล์เลจแอร์ แอนด์ทราเวล จำกัด
                                            ยืนยันว่าข้อมูลส่วนบุคคลของท่านจะไม่ถูกนำไปเปิดเผยยังหน่วยงานภายนอก
                                            หรือการส่งหรือโอนข้อมูลส่วนบุคคลไปหน่วยงานในต่างประเทศ
                                        </p>
                                        <p>
                                            <i class='fas fa-caret-right'></i>
                                            เมื่อกดชำระเงินจะถือว่าคุณได้อ่านและเข้าใจใน ข้อกำหนดและเงื่อนไข และ
                                            เงื่อนไขนโยบายความเป็นส่วนตัวของเว็บไซต์นี้เรียบร้อยแล้ว
                                    </div>
                                    <br>
                                    <div class="w3-container w3-center">
                                        <button class="button button9"> สมัครสมาชิก </button>
                                    </div>
                                </form>
                            </div>
                        </div>
