...
<head>
    ...
    <link href="css/tour-packetStep4.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="step-pack" class="container">
            <div class="step-packet">
                <ul id="progressbar">
                    ...
                    <li class="this"><label class="a">2</label>
                        <label class="b"><i class="fas fa-check"></i></label>
                        ระบุเที่ยวบิน
                    </li>
                    <li class="this"><label class="a">3</label>
                        <label class="b"><i class="fas fa-check"></i></label>
                        สำรองห้องพัก
                    </li>
        ...
        <section id="reserve-step2" class="container">
            <div class="text-h-flight">
                <p>กรอกข้อมูลของท่าน</p>
            </div>
            <br>
            <br>
            <div class="row">
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-flight">
                            <p>เที่ยวบิน</p>
                            <span>CX617 : กรุงเทพฯ - สหรัฐอเมริกา</span><br>
                            <span>เอมิเรตส์แอร์ไลน์ (EK)</span>
                            <hr>
                            <span>พฤหัสบดี 18 ก.พ. 2021</span><br>
                            <span>เวลาเดินทาง 14:00</span>
                        </div>
                    </div>
                    <br>
                    <div class="card">
                        <div class="card-flight">
                            <p>วันที่เช็คอิน</p>
                            <span>20 ก.พ. 2021 - 21 ก.พ. 2021</span><br>
                            <span>ผู้ใหญ่ 2 ท่าน, เด็ก 1 ท่าน</span>
                            <hr>
                            <span>1 x Triple Bedded Room</span><br>
                            <span>1 x Twin Bedded Room</span>
                        </div>
                    </div>
                    <br>
                    <div class="card">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">พิเศษ ฟรีนั่งกระเช้าไหว้พระใหญ่
                                        วัดโป่หลินหรือ นั่งรถเปิดประทุนชมเมือง ...</p>
                                </div>
                            </div>
                        </div>
                        <div class="more">
                            <a href="">เปลี่ยนโรงแรมเข้าพัก</a>
                        </div>
                    </div>
                    <br>
                    <div class="card">
                ...
                <div class="col-sm-8">
                    <div class="card">
                        <div class="card-flight">
                            <p>ข้อมูลผู้ติดต่อ</p>
                            <span style="color:#1940c7">ตรงตามหนังสือเดินทาง</span>
                            <br>
                            <br>
                            <div class="form-tic">
                                <div class="row">
                    ...
                    <div class="text-flight">
                        <p>ข้อมูลผู้เดินทาง</p>
                        <span style="color:#666">ตรงตามหนังสือเดินทาง</span>
                        <br><br>
                        <small style="color:#666">ผู้ใหญ่ 2 เด็ก 1</small>
                    </div>
                    <br>
                    <div class="card">
                        <div class="card-flight2">
                            <p>ผู้เดินทางคนที่ 1</p>
                            <hr>
                            <div class="form-tic">
                                <div class="row">
                                    <div class="col-sm-2">
                    ...
                    <div class="text-right">
                        <a href="tour-packetStep3.php"><button class="button1">ย้อนกลับ</button></a>
                        <a href="tour-packetStep5.php"><button class="button3">ต่อไป</button></a>
                    </div>
                </div>
            </div>
