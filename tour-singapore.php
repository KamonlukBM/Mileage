...
<head>
    ...
    <link href="css/tour-singapore.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="travel-s" class="bg-parallax"
            style="background:url(images/travel-s.png) no-repeat center center; background-size:cover;">
            <div class="container">
                <div data-aos="fade-down-right">
                    <div class="text-travel-s">
                        <p>
                            SINGAPORE
                        </p>
                    </div>
                    <div class="text-travel-s2">
                        <p>
        ...
        <section id="smart-h">
            <div class="container">
                <div class="text-smart-h">
                    <p>
                        SMART FLEX
                    </p>
                </div>
                <div class="text-smart-h2">
                    <p>
        ...
        <section id="box-slide-toursing">
            <div class="container">
                <div class="text-box-toursing">
                    <p>
                        ทัวร์ Singapore Wow
                    </p>
                </div>
        ...
        <section id="box-slide-enjoysing">
            <div class="container">
                <div class="text-box-enjoysing">
                    <p>
                        ทัวร์ Enjoy Singapore
                    </p>
                </div>
                <div data-aos="zoom-in">
                    <div class="swiper mySwiper">
        ...
        <section id="box-slide-amasing">
            <div class="container">
                <div class="text-box-amasing">
                    <p>
                        ทัวร์ Amazing Singapore
                    </p>
                </div>
                <div data-aos="zoom-in">
                    <div class="swiper mySwiper">
