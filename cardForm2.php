...
<head>
    ...
    <link href="css/cardForm2.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="sec-form2" class="container">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-h-form">
                                <p>ข้อมูลผู้ติดต่อ</p>
                                <span>ที่อยู่การจัดส่งสินค้า</span>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-sm-6 mb-3">
                                    <label class="form-label fw-normal">ชื่อ</label>
                                    <input type="text" class="form-control" placeholder="ชื่อ">
                                </div>
                                <div class="col-sm-6 mb-3">
                                    <label class="form-label fw-normal">นามสกุล</label>
                                    <input type="text" class="form-control" placeholder="นามสกุล">
                                </div>
                                <div class="col-sm-12 mb-3">
                                    <label class="form-label fw-normal">ที่อยู่</label>
                                    <input type="text" class="form-control" placeholder="ที่อยู่">
                                </div>
                                <div class="col-sm-6 mb-3">
                                    <label class="form-label fw-normal">จังหวัด</label>
                                    <input type="text" class="form-control" placeholder="จังหวัด">
                                </div>
                                <div class="col-sm-6 mb-3">
                                    <label class="form-label fw-normal">อำเภอ/เขต</label>
                                    <input type="text" class="form-control" placeholder="อำเภอ/เขต">
                                </div>
                                <div class="col-sm-6 mb-3">
                                    <label class="form-label fw-normal">ตำบล/แขวง</label>
                                    <input type="text" class="form-control" placeholder="ตำบล/แขวง">
                                </div>
                                <div class="col-sm-6 mb-3">
                                    <label class="form-label fw-normal">รหัสไปรษณีย์</label>
                                ...
                                <div class="col-sm-6 mb-3">
                                    <label class="form-label fw-normal">อีเมล์</label>
                                    <input type="text" class="form-control" placeholder="อีเมล์">
                                </div>
                                <div class="col-sm-12 mb-3">
                                    <input type="checkbox">&nbsp; <span>ข้าพเจ้ายอมรับ <a href="">นโยบายส่วนบุคคล</a> ให้สามารถจัดเก็บข้อมูลเพื่อใช้ในการติดต่อและให้ข้อมูลอันเป็นประโยชน์กับข้าพเจ้า</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-5">
                    <div class="card">
                        <div class="card-body">
                            <p>สรุปรายการสินค้า</p>
                            <div class="text-tt-form">
                                <p>ยอดรวม</p>
                                ...
                                <div class="d-flex justify-content-between border-bottom mt-3">
                                    <p>รวมทั้งสิ้น</p>
                                    <p style="font-weight: 600; font-size:18px;">฿ 200.00</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="text-tt-form">
                        <p style="color: #666;">**หลังจากซื้อสินค้าแล้วขอสงวนสิทธิ์ในการเปลี่ยนหรือคืนสินค้าในทุกกรณี</p>
                    </div>
                    <div class="but-box-slide">
                        <a href="#">
                            <button class="button button9"> เช็คเอาท์ </button>
                        </a>
                        <a href="#">
                            <button class="button button10"> ยกเลิก </button>
                        </a>
                    </div>
                </div>
            </div>
