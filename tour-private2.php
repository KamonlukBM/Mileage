...
<head>
    ...
    <link href="css/tour-private2.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="travel-tour-add2" class="bg-parallax" style="background:url(upload/tp1.png) no-repeat center center; background-size:cover;">
            ...
            <div data-aos="fade-down-right">
                ...
                <div class="text-travel-tour-article-d">
                    <p>ทริปส่วนตัว ให้ไมล์เลจแอร์ช่วยจัดทริปเฉพาะตัวให้กับคุณ
                    </p>
                </div>
            </div>
        </section>

        <section id="form-private-tour" class="container">
            <div class="text-h-city w3-center">
                <p>จองทัวร์ของคุณ</p>
            </div>
            <br>
                ...
                <div class="form-tour">
                    ...
                    <div class="row">
                        <div class="col-sm-12 mt-2">
                            <label class="form-label fw-normal">ชื่อทัวร์ของคุณ</label>
                            <input type="text" class="form-control" placeholder="ระบุชื่อทัวร์ของคุณ">
                        </div>
                        <div class="col-sm-12 mt-2">
                            <div class="row">
                        ...
                        <div class="col-sm-12 mt-4">
                            <input type="text" class="form-control" placeholder="" style="height: 120px;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-md-end text-center px-3">
                ...
                <a href="">
                    <button class="button button6">ต่อไป</button>
                </a>
            </div>
        </section>
        <br>
