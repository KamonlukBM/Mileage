...
<body>
    ...
    <main>
        ...
        <section id="travel-tour-add2" class="bg-parallax" style="background:url(upload/ht4.png) no-repeat center center; background-size:cover;">
        </section>
            ...
            <div class="container">
                ...
                <div class="time-detail-fight">
                    <p class="card-fie-text">
                        <i class="fas fa-star" style="color: #F2692B" aria-hidden="true"></i>
                        &nbsp;
                        4.85
                    </p>
                    <p class="card-time-text mt-lg-3">
                        <i class="fas fa-building" style="color: #F2692B" aria-hidden="true"></i>
                        &nbsp;
                        Victoria district
                    </p>
                    <p class="card-time-text mt-lg-3">
                        <i class="fas fa-map-marker" style="color: #F2692B" aria-hidden="true"></i>
                        &nbsp;
                        4 Cliff Rd, Yau Ma Tei, Hong Kong
                    </p>
                    <p class="card-time-text mt-lg-3">
                        <i class="fas fa-phone" style="color: #F2692B" aria-hidden="true"></i>
                        &nbsp;
                        994-885-7930
                    </p>
                </div>
                ...
                <div class="but-sec-detail2">
                    <a href="#">
                        <button class="button button20"> Google map </button>
                    </a>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="t-text-detail-d">
                                    <p>ห้องพักสำหรับ 3 ท่าน<br>Triple Bedded Room</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 col-md-2">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="t-text-detail-d">
                                    <p>ห้องพักสำหรับ 2 ท่าน<br>Twin Bedded Room</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 col-md-2">
                        <div class="card">
                            <div class="card-body">
                                <span><i class="fas fa-bed" style="margin-right:5px"></i><i class="fas fa-bed" style="margin-right:5px"></i></span>
                                <div class="t-text-detail-d">
                                    <p>ห้องพักสำหรับ 3 ท่าน<br>Double Bedded Room</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 col-md-2">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="t-text-detail-d">
                                    <p>ห้องพักสำหรับ 1 ท่าน<br>Single Bedded Room</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section id="sec-hilight">
            <div class="container">
                ...
                <div class="t-text-hilight-d">
                    ...
                    <p>
                        โรงแรมที่พัก จำนวน 1 คืน ณ โรงแรม DISNEY'S HOLLYWOOD หรือ DISNEY EXPLORER LODGE หรือ DISNEYLAND HOTEL ( 1 ห้องพักได้ 2-4 ท่าน )
                    </p>
                    <p>
                        โรงแรมที่พักในตัวเมืองฮ่องกง 1 คืน
                    </p>
                    <p>
                        ดิสนีย์แลนด์ 1 วัน ท่านละ 1 ใบ
                    </p>
                    <p>
                        ฟรีซิตี้ทัวร์ฮ่องกงครึ่งวัน (เจ้าแม่กวนอิมริมทะเล REPULSE BAY/วัดกังหัน/วัดเจ้าแม่กวนอิม HUNG HUM/โรงงานจิวเวลรี่)
                    </p>
                    <br>
                    <p>** ท่านสามารถเพิ่มจำนวนคืน พักในตัวเมืองฮ่องกงได้ เริ่มต้นท่านละ 1,000 บาทต่อท่านต่อคืน</p>
                    <br>
                    <p>** ท่านสามารถเช่ารถส่วนตัว ท่องเที่ยวตามสถานที่ที่ท่านต้องการได้ ขั้นต่ำ 4 ชั่วโมง รถตู้ (ALPHARD & ESTIMA ) 7 ที่นั่ง หรือ รถ MINIBUS 20-24 ที่นั่ง</p>
                </div>
                <hr class="new2">
            </div>
            ...
            <div class="container">
                ...
                <div class="t-text-hilight-d">
                    <div class="row">
                        <div class="col-sm-3">
                            <p>
                                <i class="fas fa-swimming-pool"></i> สระว่ายน้ำ
                            </p>
                        </div>
                        <div class="col-sm-7">
                            <p><i class="fas fa-sink"></i> ห้องครัว</p>
                        </div>
                        <div class="col-sm-3">
                            <p>
                                <i class="fas fa-hot-tub"></i> อ่างน้ำร้อน
                            </p>
                        </div>
                        <div class="col-sm-7">
                            <p><i class="fas fa-snowflake"></i> เครื่องปรับอากาศ</p>
                        </div>
                        <div class="col-sm-3">
                            <p>
                        ...
                        <div class="col-sm-7">
                            <p><i class="fas fa-dumbbell"></i> ยิม</p>
                        </div>
                        <div class="col-sm-3">
                            <p>
                                <i class="fab fa-product-hunt"></i> มีที่จอดรถฟรีบริเวณที่พัก
                            </p>
                        </div>
                        <div class="col-sm-7">
                            <p><i class="fas fa-door-closed"></i> ลิฟท์</p>
                        </div>
                        <div class="col-sm-3">
                            <p>
                                <i class="fas fa-video"></i> ที่พักมีกล้องวงจรปิด
                            </p>
                        </div>
                        <div class="col-sm-7">
                            <p><i class="fas fa-ban"></i> เครื่องตรวจจับก๊าซคาร์บอนมอนอกไซด์</p>
                        </div>
                    </div>
                </div>
                <hr class="new2">
        ...
        <section id="sec-hilight">
            <div class="container">
                <div class="t-text-hilight-h">
                    <p>
                        แหล่งช็อปปิ้งกินเที่ยวรอบโรงแรม
                    </p>
                </div>
                <div class="t-text-hilight-d">
                    <ul>
                        ...
                        <li>Market Square</li>
                        <li>Victoria Public Market at the Hudson</li>
