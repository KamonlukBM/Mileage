...
<head>
    ...
    <link href="css/cardForm.css" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section id="sec-form" class="container">
            <div class="text-h-city">
                <p>Your Shopping Bag</p>
            </div>
            <p>คุณมีสินค้า 2 รายการในรถเข็น</p>
            ...
            <div class="row">
                <div class="col-sm-8">
                    <p style="color: red;">**หลังจากซื้อสินค้าแล้วขอสงวนสิทธิ์ในการเปลี่ยนหรือคืนสินค้าในทุกกรณี</p>
                </div>
                <div class="col-sm-4">
                    <p>สรุปค่าใช้จ่าย</p>
